      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-6 signin text-right navbar-nav">
            <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/home')); ?>" class="scroll stroke"><b>Home</b></a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="scroll stroke"><b>Login</b></a>&nbsp; 
                        &nbsp;<a href="<?php echo e(route('register')); ?>" class="scroll stroke"><b>Register</b></a>&nbsp;
                    <?php endif; ?>
            <?php endif; ?>
